...
public class ProductManager implements ProductService {
    ...
    //projeyi tarar bu interface i alacak class ı oluşturur constructor ın içinde new ler . topluca
    //bunu attribute başına da yazabilirdik
    @Autowired
    ...
    public DataResult<Product> getByProductNameAndCategoryId(String productName, int categoryId) {
        //Business code lar yazılacak buraya
